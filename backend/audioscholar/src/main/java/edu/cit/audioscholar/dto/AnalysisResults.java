...
public class AnalysisResults {
	...
	public AnalysisResults(List<String> keywordsAndTopics) {
		this.keywordsAndTopics = Collections
				.unmodifiableList(keywordsAndTopics != null ? keywordsAndTopics : Collections.emptyList());
		this.success = true;
	...
	public String toString() {
		return "AnalysisResults{" + "keywordsAndTopics=" + keywordsAndTopics + ", success=" + success
