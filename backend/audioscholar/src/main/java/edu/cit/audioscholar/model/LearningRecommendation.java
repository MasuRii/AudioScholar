...
public class LearningRecommendation {
	...
	public LearningRecommendation(String videoId, String title, String descriptionSnippet, String thumbnailUrl,
			String recordingId) {
	...
	public LearningRecommendation(String videoId, String title, String descriptionSnippet, String thumbnailUrl,
			String recordingId, Integer relevanceScore, Boolean isEducational, String channelTitle) {
		this.videoId = videoId;
		this.title = title;
		this.descriptionSnippet = descriptionSnippet;
		this.thumbnailUrl = thumbnailUrl;
	...
	public static LearningRecommendation fromMap(Map<String, Object> map) {
		...
		if (recommendation.fallbackThumbnailUrl == null && recommendation.videoId != null) {
			recommendation.fallbackThumbnailUrl = "https://i.ytimg.com/vi/" + recommendation.videoId + "/hqdefault.jpg";
		}
	...
	public String toString() {
		return "LearningRecommendation{" + "recommendationId='" + recommendationId + '\'' + ", videoId='" + videoId
				+ '\'' + ", title='" + title + '\'' + ", descriptionSnippet='" + descriptionSnippet + '\''
				+ ", thumbnailUrl='" + thumbnailUrl + '\'' + ", fallbackThumbnailUrl='" + fallbackThumbnailUrl + '\''
				+ ", thumbnailQuality='" + thumbnailQuality + '\'' + ", recordingId='" + recordingId + '\''
				+ ", relevanceScore=" + relevanceScore + ", isEducational=" + isEducational + ", channelTitle='"
				+ channelTitle + '\'' + ", createdAt=" + createdAt + '}';
	}
}
