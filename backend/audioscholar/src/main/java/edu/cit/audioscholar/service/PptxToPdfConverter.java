...
public class PptxToPdfConverter {
	...
	public void convert(InputStream pptxInputStream, OutputStream pdfOutputStream) throws Exception {
		...
		try (XMLSlideShow ppt = new XMLSlideShow(pptxInputStream); PDDocument pdf = new PDDocument()) {
