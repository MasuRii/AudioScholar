...
public class SecurityConfig {
	...
	SecurityFilterChain statefulFilterChain(HttpSecurity http) throws Exception {
		RequestMatcher statefulEndpoints = new OrRequestMatcher(AntPathRequestMatcher.antMatcher("/"),
				AntPathRequestMatcher.antMatcher("/images/**"), AntPathRequestMatcher.antMatcher("/css/**"),
				AntPathRequestMatcher.antMatcher("/favicon.ico"), AntPathRequestMatcher.antMatcher("/login/**"),
				AntPathRequestMatcher.antMatcher("/oauth2/**"), AntPathRequestMatcher.antMatcher("/error"),
				AntPathRequestMatcher.antMatcher("/api/auth/token"));

		http.securityMatcher(statefulEndpoints)
				.authorizeHttpRequests(authz -> authz.requestMatchers(AntPathRequestMatcher.antMatcher("/"),
						AntPathRequestMatcher.antMatcher("/images/**"), AntPathRequestMatcher.antMatcher("/css/**"),
						AntPathRequestMatcher.antMatcher("/favicon.ico"), AntPathRequestMatcher.antMatcher("/login/**"),
						AntPathRequestMatcher.antMatcher("/oauth2/**"), AntPathRequestMatcher.antMatcher("/error"))
						.permitAll().requestMatchers(AntPathRequestMatcher.antMatcher("/api/auth/token"))
	...
	SecurityFilterChain statelessFilterChain(HttpSecurity http) throws Exception {
		...
		http.securityMatcher("/api/**")
				.authorizeHttpRequests(authz -> authz
						...
						.requestMatchers(AntPathRequestMatcher.antMatcher("/api/**")).authenticated().anyRequest()
						.denyAll())
