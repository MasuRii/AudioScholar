...
public class NhostUploadMessage implements Serializable {
	...
	@JsonCreator
	public NhostUploadMessage(@JsonProperty("metadataId") String metadataId, @JsonProperty("fileType") String fileType,
	...
	public String toString() {
		return "NhostUploadMessage{" + "metadataId='" + metadataId + '\'' + ", fileType='" + fileType + '\''
				+ ", tempFilePath='" + tempFilePath + '\'' + ", originalFilename='" + originalFilename + '\''
